...
import {Sample, UserReducerChallengeTwo, Counter, Stopwatch, Form, CatFriends, StateComponent,  VideoPlayer, CounterButton, NameAgeForm} from './components/sample/index'

function App() {
  return (
      <UserReducerChallengeTwo/>
  )
}
